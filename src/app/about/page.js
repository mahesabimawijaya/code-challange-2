  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center w-full pt-14">
        ...
        <div className="flex w-full justify-center md:justify-start text-xl md:text-3xl font-semibold my-10 md:pl-24">
          <div>Introduction</div>
        </div>
        <div className=" flex flex-col items-center md:items-start space-y-16 md:flex md:flex-row w-full md:px-24 md:space-x-24">
          ...
          <div className="relative w-52 md:w-1/3 h-32 md:h-36 lg:h-44 xl:h-64">
