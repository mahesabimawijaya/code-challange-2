  ...
  return (
    <>
      ...
      <div className="pt-16 flex flex-col w-screen h-screen overflow-x-hidden">
        ...
        <div className="flex flex-col lg:flex lg:flex-row w-full justify-center items-center mt-14 lg:space-x-2 xl:space-x-5 lg:flex-wrap">
          {data.results.map((user, index) => {
            return (
              <div
                key={index}
                id="user-container"
                className="w-64 lg:w-1/5 border rounded-t-full border-blue-700 h-80 flex flex-col py-8 px-2 items-center mb-5 group hover:bg-blue-800 duration-300 cursor-help"
              >
